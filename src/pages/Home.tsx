...
const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-minimal-blue via-minimal-blueLight to-white flex flex-col">
      ...
      <div className="relative w-full flex flex-col items-center justify-start pt-10 pb-24 px-4 md:px-0">
        ...
        <div className="relative z-20 flex flex-col items-center w-full max-w-md mx-auto">
          {/* 앱명 */}
          <h1 className="text-2xl md:text-3xl font-extrabold text-white drop-shadow-lg mb-2 tracking-tight font-minimal">아무것도 들어 간것 없다</h1>
          {/* 슬로건 */}
          <p className="text-base md:text-lg text-white font-semibold mb-4 font-minimal">"우리가족 레시피"</p>
          {/* 메인 이미지 */}
          <img
          ...
          <div className="flex items-center gap-2 mb-4 bg-white/70 px-4 py-2 rounded-full shadow-md">
            <span className="text-sm md:text-base text-minimal-blue font-semibold">등록된 레시피</span>
      ...
      <div className="relative z-20 -mt-24 w-full max-w-lg mx-auto px-4">
        <div className="bg-white rounded-3xl shadow-xl px-6 py-8 flex flex-col items-center">
          {/* 예시 타이틀/버튼/컨텐츠 */}
          <h2 className="text-lg md:text-xl font-bold text-minimal-blue mb-2">오늘의 추천 레시피</h2>
          <p className="text-gray-500 mb-4 text-center">가장 인기있는 레시피를 확인해보세요!</p>
          <Link
            to="/recipes"
